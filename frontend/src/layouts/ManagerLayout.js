          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 bg-white dark:bg-slate-950">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="leading-tight min-w-0">
                <p className="text-sm font-semibold text-gray-900 dark:text-slate-100 truncate tracking-tight">Manager Portal</p>
              </div>
            </div>
            <button 
        ...
        <div className="flex flex-col flex-grow bg-white dark:bg-slate-950 border-r border-slate-200/70 dark:border-slate-800 shadow-xl">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 bg-white dark:bg-slate-950">
            <div className={`flex items-center ${sidebarCollapsed ? 'justify-center w-full' : 'gap-3'}`}>
              ...
              {!sidebarCollapsed && (
                <div className="leading-tight min-w-0">
                  <p className="text-sm font-semibold text-gray-900 dark:text-slate-100 tracking-tight">Manager Portal</p>
                </div>
              )}
            </div>
            {!sidebarCollapsed && (
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              <div className="relative profile-menu-container">
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-gray-900 dark:text-white max-w-[10rem] truncate pointer-events-none mr-2">{user?.name || user?.full_name || 'Manager'}</span>
